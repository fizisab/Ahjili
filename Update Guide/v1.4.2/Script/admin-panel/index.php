    ...
    if ($config['live_video_save'] == 0) {
        try {
            ...
            foreach ($posts as $key => $post) {
                ...
                Stream_DeleteVideo(Generic::secure($post->post_id));
            }
        } catch (Exception $e) {}
                ...
                <ul class="list">
                    ...
                    <li class="<?php echo $admin->activeMenu('settings'); ?>">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li class="<?php echo $admin->activeMenu('live'); ?>">
                                <a href="<?php echo pxp_acp_link('live'); ?>" class=" waves-effect waves-block">Live Stream Settings</a>
                            </li> 
                        </ul>
                    </li>
                    ...
                    <li class="<?php echo $admin->activeMenu('reports'); ?>">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li class="<?php echo $admin->activeMenu('fund-reports'); ?>">
                                <a href="<?php echo pxp_acp_link('fund-reports'); ?>" class="waves-effect waves-block">
